...
| `pipeline/configs/almapay.json` | Config client pour le PPTX |
...
- **Manuel** : Actions → *Screaming Frog lite - almapay.com* → Run workflow
...
URL : **https://willotalexispro.github.io/sanity-check-almapay/**
...
Expéditeur : `noreply@mail.almapay.com` (domaine vérifié sur Resend)
...
- Envoyé au webhook n8n : `https://n8n.almapay.com/webhook/44f8feb9-f516-43ce-aacc-e12729743ca8`
...
4. Modifier `pipeline/configs/almapay.json` (nom client)
5. Mettre à jour les URLs dans `.github/workflows/crawl.yml` :
   - `--crawl https://almapay.com/`
